...
<div class="vip-login-form" style="margin: 5px;">
    ...
    <?= $form->field($model, 'vip_no')->textInput(['type'=>'number','maxlength' => 11,'placeholder'=>'请输入您的手机号码'])?>
    ...
    <?php if(empty($parent_vip_no)){?>
    	<?= $form->field($model, 'parent_vip_no')->textInput(['type'=>'number','maxlength' => 11,'placeholder'=>'请输入推荐手机号码'])?>
    <?php }else{ ?>
